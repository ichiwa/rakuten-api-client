 ...
 */
public class IchibaItemRankingApi extends BaseApi {

    private final String BASE_URL = Common.ICHIBA_ITEM_RANKING_URL;
    private final String VERSION = Common.ICHIBA_ITEM_RANKING_VERSION;
